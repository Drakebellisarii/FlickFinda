        ...
        {loading && (
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <p className="text-white text-lg font-medium">Loading your watchlist...</p>
            </div>
          </div>
        )}
          ...
          >
            {watchlist.map((item, index) => (
              <motion.div
                ...
                className="rounded-xl overflow-hidden shadow-card hover:shadow-card-hover transition-all relative group border border-gold/30"
              >
                {/* Movie Poster */}
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-retro-orange/0 group-hover:bg-retro-orange/10 backdrop-blur-0 group-hover:backdrop-blur-sm transition-all duration-300" />
                </div>

                {/* Movie Info - Glass card overlay */}
                <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 glass-card-dark border-t-2 border-gold/40">
                  <h3 className="text-base sm:text-lg md:text-xl font-playfair font-bold text-white mb-2 line-clamp-2">
                    {item.title}
                  </h3>
                  <p className="text-apple-gray-300 text-xs sm:text-sm mb-3 sm:mb-4">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold py-2 px-3 sm:px-4 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed text-xs sm:text-sm min-h-[44px] shadow-lg border border-red-500/50"
                  >
                    {removingId === item.id ? (
